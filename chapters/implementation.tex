...
In this section we discuss the implementation of operators in HyPer in general. With this model in mind we can then show how k-Means can be implemented to be used in this programming model. 
\\
