...
\begin{figure}[htsb]
  ...
  \caption[High Dimensional - Time per Iteration (Serial)]{High Dimensional - Time per Iteration.}
...
\begin{table}[htsb]
  \caption[3D Network - Time per Iteration (Competitors)]{3D Network - Time per Iteration in seconds.}
